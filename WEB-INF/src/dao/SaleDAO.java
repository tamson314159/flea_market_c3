...
public class SaleDAO {
	...
	public ArrayList<Sale> selectAllAdmin(String product_id) {
		Connection con = null;
		Statement smt = null;
		...
		String sql = "SELECT a.product_name,a.kinds,a.price,a.quantity,a.remarks,a.region,"
				...
				+ "b.purchase_user_id FROM product a,purchase_info b WHERE " + product_id;
		try {
			con = getConnection();
	...
	public ArrayList<Sale> selectAllUser(String product_id) {
		Connection con = null;
		Statement smt = null;
		...
		String sql = "SELECT a.product_name,a.kinds,a.price,a.quantity,a.remarks,a.region,"
				+ "a.exhibition_date,a.update_date,a.image,a.transaction,a.user_id,"
				+ "b.purchase_user_id,b.purchase_date,b.money_received,b.delivery FROM product a,purchase_info b WHERE"
				+ product_id;
		try {
			con = getConnection();
			smt = con.createStatement();
	...
	public ArrayList<Sale> selectAllbought(String product_id) {
...
​
	...
	public int update(Sale sale) {
		...
		String sql = "UPDATE product AS a INNER JOIN purchase AS b ON a.product_id = b.product_number"
				...
				+ sale.getTransaction() + "',a.delivery='" + sale.getDelivery() + "' WHERE a.product_number='"
